export default {
  en: {
    ...
    'pages.page-rerendered': 'Page rerendered',
    'pages.section-rerendered': 'Section rerendered',
    'pages.new': 'New page',
    'pages.rerender': 'Rerender pages/sections',
    ...
    'pages.rerender-page': 'Rerender page',
    'pages.rerender-section': 'Rerender section',
  ...
  no: {
    ...
    'pages.page-rerendered': 'Siden ble gjengitt på nytt',
    'pages.section-rerendered': 'Seksjonen ble gjengitt på nytt',
    'pages.new': 'Ny side',
    'pages.rerender': 'Behandle sider og seksjoner på nytt',
    ...
    'pages.rerender-page': 'Behandle siden på nytt',
    'pages.rerender-section': 'Behandle seksjonen på nytt',
